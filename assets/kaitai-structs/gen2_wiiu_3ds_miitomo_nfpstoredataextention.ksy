meta:
  id: gen2_wiiu_3ds_miitomo_nfpstoredataextention
  endian: le
seq:
  - id: unknown_1
    type: u1
  ...
  - id: checksum
    type: u2le
  # nn::mii::detail::NfpStoreDataExtentionRaw fields appended to the end
  ...
  - id: ext_faceline_color
    type: u1
  - id: ext_hair_color
    type: u1
  - id: ext_eye_color
    type: u1
  - id: ext_eyebrow_color
    type: u1
  - id: ext_mouth_color
    type: u1
  - id: ext_beard_color
